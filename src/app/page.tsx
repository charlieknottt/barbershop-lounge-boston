        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          <a href="#" className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="font-serif text-xl sm:text-2xl font-bold text-cream">
              BARBERSHOP<span className="text-forest"> LOUNGE</span>
            </span>
          </a>
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <h1 className="font-serif text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold text-cream mb-4 sm:mb-6 animate-fade-in leading-tight">
          BARBERSHOP
          <br />
          <span className="text-gradient">LOUNGE</span>
        </h1>
        <p className="text-cream/60 font-sans text-base sm:text-lg md:text-xl max-w-xl mx-auto mb-8 sm:mb-10 animate-fade-in-up px-4">
          Boston&apos;s only dual licensed men&apos;s salon and barbershop. Over 16 years of premium grooming on Newbury Street.
        </p>
...
function ServicesSection() {
  const services = [
    {
      name: "Scissor Cut",
      description: "Classic precision scissor cut tailored to your style",
      price: "$55",
      duration: "45 min",
    },
    {
      name: "Faded Haircut",
      description: "Sharp, clean fade with expert blending",
      price: "$45",
      duration: "40 min",
    },
    {
    ...
    {
      name: "Haircut & Beard",
      description: "Complete grooming experience with cut and beard service",
      price: "$70",
      duration: "60 min",
    },
    {
      name: "Straight Razor Shave",
      description: "Luxurious traditional straight razor shave with hot towel",
      price: "$45",
      duration: "40 min",
    },
    {
      name: "Color Blending",
      description: "Seamless grey blending or color enhancement",
      price: "$40",
      duration: "30 min",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          <AnimatedSection delay={200}>
            ...
            <div className="space-y-4 sm:space-y-6 text-forest/70 font-sans leading-relaxed text-sm sm:text-base">
              <p>
                Since 2008, Barbershop Lounge has been redefining men&apos;s grooming
                in Boston&apos;s Back Bay. As the only dual licensed men&apos;s salon and
                barbershop on Newbury Street, we bring together the best of both
                worlds in one relaxed, modern space.
              </p>
              <p>
                Our team brings over 100 years of collective experience and a
                genuine passion for the craft. From professional athletes and
                finance executives to students and travelers, every client gets
                the same attention to detail.
              </p>
              <p className="hidden sm:block">
                Step into our shop and experience the difference that true
                craftsmanship makes. From classic scissor cuts to contemporary
                fades and straight razor shaves, we&apos;ve got you covered.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 mt-8 sm:mt-12 pt-8 sm:pt-12 border-t border-forest/10">
              <div className="text-center sm:text-left">
                <p className="font-serif text-2xl sm:text-4xl text-forest mb-1 sm:mb-2">16+</p>
                <p className="text-forest/50 text-xs sm:text-sm uppercase tracking-wider">
                  Years
                </p>
              </div>
              <div className="text-center sm:text-left">
                <p className="font-serif text-2xl sm:text-4xl text-forest mb-1 sm:mb-2">10K+</p>
                <p className="text-forest/50 text-xs sm:text-sm uppercase tracking-wider">
                  Clients
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <AnimatedSection>
            <div className="bg-cream-dark border border-cream/10 overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2948.4!2d-71.0775!3d42.3495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e37a0e3c8b3d0f%3A0x0!2s245%20Newbury%20St%2C%20Boston%2C%20MA%2002116!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
              <div>
                <h3 className="font-serif text-lg sm:text-xl text-cream mb-1 sm:mb-2">BARBERSHOP LOUNGE</h3>
                <p className="text-cream/60 text-sm sm:text-base">
                  245 Newbury Street<br />
                  Boston, MA
                </p>
              </div>
              <a
              ...
              <div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=245+Newbury+St+Boston+MA+02116"
                  target="_blank"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-cream/50 font-sans mb-4 sm:mb-6 text-sm sm:text-base">
              Boston&apos;s premier men&apos;s salon and barbershop on Newbury Street.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 text-cream/50 text-sm sm:text-base">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <a href="tel:6174500021" className="hover:text-cream transition-colors py-1 touch-manipulation">
                  (617) 450-0021
                </a>
              </div>
            </div>
        ...
        <div className="mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-cream/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-cream/30 text-xs sm:text-sm text-center sm:text-left">
            &copy; {new Date().getFullYear()} Barbershop Lounge. All rights reserved.
          </p>
